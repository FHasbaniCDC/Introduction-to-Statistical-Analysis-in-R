...
1-pbinom(4,size=10,prob=.6) #complement
pbinom(4,size=10,prob=.6) #.1662

#the following are scripts confirming the discrete calculation.
dbinom(4,size = 10,prob=.6) +#.111
